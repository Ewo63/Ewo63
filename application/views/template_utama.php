    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="<?php echo base_url(); ?>" class="simple-text">
                    <i class="pe-7s-study"></i> Sistem Informasi Penilaian Siswa
                </a>
            </div>
            <ul class="nav">
                <?php
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><i class="pe-7s-study"></i> Sistem Informasi Penilaian Siswa</a>
                </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <p class="copyright pull-left">
                    <b><?php echo $this->config->item('SDN 1 Tambaksari'); ?></b>  <a href="https://github.com/akhwan90/rapor2013/Sumber Asli" target="_blank">Dikembangkan Oleh Ewo Susanto</a> 
                </p>
